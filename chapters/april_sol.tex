...
\subsection[2025-2026b]{\hyperref[sec:kr_03_2025_2026b]{2025-2026b}}
\label{sec:sol_kr_03_2025_2026b} % \label{ссылка сюда}

\begin{enumerate}
    \item $y_{102} = 31.12 + 0.14 u_{101} + u_{102}$, $PI = [31.12 - 1.96 \sqrt{101.96}; 31.12 + 1.96 \sqrt{101.96}]$, $\P(A) = 1- F(0.88)$.
    \item $\hat y_{100} = 25$, $\hat y_{101} = 15$;
    $y_1 = 15 + u_1$, $y_2 = 25 + 0.5u_1 + u_2$, 
    \[
    \E(y_1 \mid y_2) = 15 + \Cov(y_1, y_2)/\Var(y_2)(y_2 - 25).
    \]
    \item $\E(y_t) = 10$, 
    \[
    \gamma_k = \begin{cases}
    ...
    \end{cases}
    \]
    $(y_t)$ is stationary but not invertible with respect to $(u_t)$.
    \[
    y_t = 10 + v_t + 0.2 v_{t-1}
    \]
\end{enumerate}
